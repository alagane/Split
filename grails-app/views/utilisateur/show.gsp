...
<html>
	...
	<body>
			...
			<ol class="property-list utilisateur">
				...
				<li class="fieldcontain">
					<span id="password-label" class="property-label"><g:message code="utilisateur.password.label" default="Password" /></span>
						...
						<span class="property-value hidden-password" aria-labelledby="password-label"><g:fieldValue bean="${utilisateurInstance}" field="password"/></span>
	    ...
	    <div>
			<g:link action="create" controller="personnalite">Créer une personnalité</g:link>
        </div>
	</body>
</html>
